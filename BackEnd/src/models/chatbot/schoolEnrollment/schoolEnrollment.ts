...
import { searchEnrollment } from "../../../../helper/services/schoolEnrollment.database";
...
export const enrollmentQuery = async (
  userId: number,
  message: string,
  ...
  try {
        ...
        switch (action) {
          case "get_enrollment_info": {
            ...
            try {
              ...
              if (
                dbResult.includes("No enrollment information found") ||
    ...
    console.error("Error in enrollmentQuery:", error);
